...
The susR package provides a simple and consistent R interface to the Slovak Statistical Office (SUSR) open data API. It streamlines tasks like:

Listing available datasets (tables).
Retrieving dimension codes and values for a selected table.
...
For more details on additional functions, usage examples, and how to retrieve the actual data, check out the package documentation and vignettes once susR is installed.
