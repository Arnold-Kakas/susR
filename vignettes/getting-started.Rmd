...
vignette: >
  %\VignetteIndexEntry{Getting Started with susR}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

<!--
  Note: This .Rmd will be compiled into a vignette.
  Place this file in your package's "vignettes/" folder, then use:
    devtools::build_vignettes()
  or
    devtools::install(build_vignettes = TRUE)
  to generate it and include it in the package.
-->
...
multi_res$as1001rs |>
  dplyr::filter(as1001rs_ukaz == "Pre-productive population (aged 0 -14 years)",
         as1001rs_poh == "Total") |>
  ggplot2::ggplot() +
  ggplot2::geom_line(ggplot2::aes(x = as1001rs_rok, y = value, group = 1)) +
  ggplot2::labs(title = "Pre-productive population (aged 0 -14 years)",
       x = "Year",
       y = NULL) +
